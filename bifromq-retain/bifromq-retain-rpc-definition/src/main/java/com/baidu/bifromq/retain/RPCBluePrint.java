...
public class RPCBluePrint {
    public static final BluePrint INSTANCE = BluePrint.builder()
        ...
        .methodSemantic(RetainServiceGrpc.getRetainMethod(), BluePrint.WRPipelineUnaryMethod.INSTANCE)
        .methodSemantic(RetainServiceGrpc.getMatchMethod(), BluePrint.WRUnaryMethod.INSTANCE)
        .build();
}
