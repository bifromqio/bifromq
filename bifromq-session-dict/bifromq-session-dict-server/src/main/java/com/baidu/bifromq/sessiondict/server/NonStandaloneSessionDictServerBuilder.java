...
@Setter
public final class NonStandaloneSessionDictServerBuilder
    extends AbstractSessionDictServerBuilder<NonStandaloneSessionDictServerBuilder> {
    RPCServerBuilder rpcServerBuilder;

    @Override
    public ISessionDictServer build() {
        Preconditions.checkNotNull(rpcServerBuilder, "RPC Server Builder is null");
        return new NonStandaloneSessionDictServer(this);
    }
}
