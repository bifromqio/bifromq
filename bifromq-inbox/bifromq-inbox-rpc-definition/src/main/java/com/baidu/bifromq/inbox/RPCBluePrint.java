...
public class RPCBluePrint {
    public static final BluePrint INSTANCE = BluePrint.builder()
        ...
        // broker client rpc
        .methodSemantic(InboxServiceGrpc.getReceiveMethod(), BluePrint.WCHPipelineUnaryMethod.INSTANCE)
        ...
        // reader client rpc
        .methodSemantic(InboxServiceGrpc.getCreateInboxMethod(), BluePrint.WRUnaryMethod.INSTANCE)
        .methodSemantic(InboxServiceGrpc.getDeleteInboxMethod(), BluePrint.WRUnaryMethod.INSTANCE)
        .methodSemantic(InboxServiceGrpc.getFetchMethod(), BluePrint.WCHStreamingMethod.INSTANCE)
