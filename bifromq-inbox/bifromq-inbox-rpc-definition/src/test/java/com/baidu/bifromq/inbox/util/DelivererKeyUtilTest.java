...
public class DelivererKeyUtilTest {
    private static final String TENANT_ID = "tenant1";
    private static final String INBOX_ID = "inbox123";

    @Test
    void testParseTenantId() {
        String delivererKey = DelivererKeyUtil.getDelivererKey(TENANT_ID, INBOX_ID);
        String tenantId = DelivererKeyUtil.parseTenantId(delivererKey);
