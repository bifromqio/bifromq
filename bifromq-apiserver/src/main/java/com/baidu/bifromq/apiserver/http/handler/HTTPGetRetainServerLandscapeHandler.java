...
@Slf4j
@Path("/server/retain")
public class HTTPGetRetainServerLandscapeHandler extends HTTPGetServerLandscapeHandler {
    private final Single<Set<IRPCServiceTrafficDirector.Server>> landscapeSingle;

    public HTTPGetRetainServerLandscapeHandler(IRetainClient retainClient) {
