...
@Path("/groups/server/inbox")
public class HTTPSetInboxServerGroupsHandler extends HTTPSetServerGroupsHandler {
    private final IRPCServiceTrafficGovernor trafficGovernor;

    public HTTPSetInboxServerGroupsHandler(IInboxClient inboxClient) {
