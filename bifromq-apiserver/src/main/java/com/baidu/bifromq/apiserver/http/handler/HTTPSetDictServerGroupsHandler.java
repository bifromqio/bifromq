...
@Path("/groups/server/dict")
public class HTTPSetDictServerGroupsHandler extends HTTPSetServerGroupsHandler {
    private final IRPCServiceTrafficGovernor trafficGovernor;

    public HTTPSetDictServerGroupsHandler(ISessionDictClient dictClient) {
        this.trafficGovernor = dictClient.trafficGovernor();
    }
