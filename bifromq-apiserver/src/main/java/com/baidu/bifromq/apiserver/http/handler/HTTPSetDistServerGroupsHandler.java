...
@Path("/groups/server/dist")
public class HTTPSetDistServerGroupsHandler extends HTTPSetServerGroupsHandler {
    private final IRPCServiceTrafficGovernor trafficGovernor;

    public HTTPSetDistServerGroupsHandler(IDistClient distClient) {
        this.trafficGovernor = distClient.trafficGovernor();
    }
