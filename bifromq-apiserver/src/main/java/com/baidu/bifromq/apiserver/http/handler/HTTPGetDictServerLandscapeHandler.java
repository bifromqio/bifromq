...
@Slf4j
@Path("/server/dict")
public class HTTPGetDictServerLandscapeHandler extends HTTPGetServerLandscapeHandler {
    private final Single<Set<IRPCServiceTrafficDirector.Server>> landscapeSingle;

    public HTTPGetDictServerLandscapeHandler(ISessionDictClient dictClient) {
