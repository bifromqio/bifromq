...
@Slf4j
@Path("/server/broker")
public class HTTPGetBrokerServerLandscapeHandler extends HTTPGetServerLandscapeHandler {
    private final Single<Set<IRPCServiceTrafficDirector.Server>> landscapeSingle;

    public HTTPGetBrokerServerLandscapeHandler(IMqttBrokerClient brokerClient) {
