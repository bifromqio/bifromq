...
@Slf4j
public abstract class BatchCallScheduler3<Call, CallResult, BatcherKey>
    implements IBatchCallScheduler<Call, CallResult> {
    private static final int BUILDER_EXPIRY_SECONDS = 3000;
    ...
    public BatchCallScheduler3(String name, Duration maxTolerantLatency) {
        this(name, new ICallScheduler<>() {
        }, maxTolerantLatency);
    }

    public BatchCallScheduler3(String name, ICallScheduler<Call> reqScheduler, Duration maxTolerantLatency) {
