...
@Getter
@Setter
public class DistServerConfig implements StarterConfig {
    ...
    private StoreClientConfig distWorkerStoreClientConfig = new StoreClientConfig();

    private String distCallPreBatchSchedulerFactoryClass;
