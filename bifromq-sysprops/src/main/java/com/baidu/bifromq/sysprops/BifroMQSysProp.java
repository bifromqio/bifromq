...
public enum BifroMQSysProp {
    ...
    INBOX_STORE_LOAD_EST("inbox_store_enable_load_est", true, BooleanParser.INSTANCE),
    INBOX_STORE_LOAD_EST_IO_NANOS_LIMIT("inbox_store_io_nanos_limit", 30_000L, LongParser.POSITIVE),
    INBOX_STORE_LOAD_EST_MAX_IO_DENSITY("inbox_store_max_io_density", 40L, LongParser.POSITIVE),
    INBOX_STORE_LOAD_EST_WINDOW_SECONDS("inbox_store_load_estimation_window_seconds", 10, IntegerParser.POSITIVE),
