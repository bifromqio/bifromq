...
public enum BifroMQSysProp {
    ...
    CONTROL_PLANE_TOLERABLE_LATENCY_MS("control_plane_tolerant_latency_ms", 200L, LongParser.POSITIVE),
    ...
    INBOX_STORE_LOAD_EST_MAX_IO_DENSITY("inbox_store_max_io_density", 60, IntegerParser.POSITIVE),
