...
public enum BifroMQSysProp {
    ...
    MAX_CACHED_AUTH_RESULTS("max_cached_auth_results", 100000L, LongParser.NON_NEGATIVE),
    MAX_CACHED_CHECK_RESULTS("max_cached_check_results", 100000L, LongParser.NON_NEGATIVE),
    AUTH_RESULT_EXPIRY_SECONDS("auth_result_expiry_seconds", 5L, LongParser.NON_NEGATIVE),
    CHECK_RESULT_EXPIRY_SECONDS("check_result_expiry_seconds", 5L, LongParser.NON_NEGATIVE),
