...
public final class BehaviorSubject<T> extends Subject<T> {
     ...
     *                     {@link io.reactivex.rxjava3.subjects.BehaviorSubject} has not yet observed any items from its
    ...
    BehaviorSubject(T defaultValue) {
        ...
        this.observers = new AtomicReference<>(ConcurrentHashMap.newKeySet());
