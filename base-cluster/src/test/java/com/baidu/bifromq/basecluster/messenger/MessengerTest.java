...
import static com.baidu.bifromq.baseutils.PortUtil.freePorts;
...
public class MessengerTest {
    ...
    public void init() {
        ...
        local = new InetSocketAddress("127.0.0.1", ports[0]);
        remote = new InetSocketAddress("127.0.0.1", ports[1]);
