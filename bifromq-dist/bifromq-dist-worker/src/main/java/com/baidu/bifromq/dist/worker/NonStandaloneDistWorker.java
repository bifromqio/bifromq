...
@Slf4j
final class NonStandaloneDistWorker extends AbstractDistWorker<NonStandaloneDistWorkerBuilder> {
    private final IBaseKVStoreServer storeServer;

    public NonStandaloneDistWorker(NonStandaloneDistWorkerBuilder builder) {
        super(builder);
