...
@Slf4j
public class DistWorkerCallScheduler extends BatchCallScheduler<DistWorkerCall, Map<String, Integer>, Integer>
    ...
    public DistWorkerCallScheduler(ICallScheduler<DistWorkerCall> callScheduler, IBaseKVStoreClient kvStoreClient) {
    ...
    @Override
    protected BatchCallBuilder<DistWorkerCall, Map<String, Integer>> newBuilder(String name, int maxInflights,
                                                                                Integer batchKey) {
    ...
    private class DistWorkerCallBuilder extends BatchCallBuilder<DistWorkerCall, Map<String, Integer>> {
        private class DistWorkerCall
            implements IBatchCall<com.baidu.bifromq.dist.server.scheduler.DistWorkerCall, Map<String, Integer>> {
            ...
            @Override
            public CompletableFuture<Map<String, Integer>> add(
                com.baidu.bifromq.dist.server.scheduler.DistWorkerCall dist) {
