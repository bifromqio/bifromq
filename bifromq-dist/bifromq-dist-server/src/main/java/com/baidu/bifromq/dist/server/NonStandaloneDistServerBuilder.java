...
@Setter
public final class NonStandaloneDistServerBuilder extends AbstractDistServerBuilder<NonStandaloneDistServerBuilder> {
    RPCServerBuilder rpcServerBuilder;

    @Override
    public IDistServer build() {
        Preconditions.checkNotNull(rpcServerBuilder, "RPC Server Builder is null");
        return new NonStandaloneDistServer(this);
    }
}
